...
export const aggregateProjectStats = (projectsData) => {
  ...
  projectsData.forEach((projectData) => {
    ...
    Object.keys(timeByIteration).forEach((iterationName) => {
      ...
      aggregate.timeByIteration[iterationName] +=
        timeByIteration[iterationName];
    });
    ...
    Object.keys(nodeStats.byIteration).forEach((iterationId) => {
      ...
      aggregate.nodesByIteration[iterationId] +=
        nodeStats.byIteration[iterationId];
    });
 ...
 */
export const getAggregateTimeInDateRange = (
  projectsData,
  startDate,
  endDate,
) => {
