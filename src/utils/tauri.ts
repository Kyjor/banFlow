...
const commandMap: Record<string, string> = {
  ...
  'git:linkRepositoryToProject': 'git_link_repository_to_project',
  'git:unlinkRepositoryFromProject': 'git_unlink_repository_from_project',
  'git:setActiveProjectRepository': 'git_set_active_project_repository',
  'git:loadProjectRepositories': 'git_load_project_repositories',
  'git:getProjectRepositoryStats': 'git_get_project_repository_stats',
  'git:cleanupProjectRepositories': 'git_cleanup_project_repositories',
