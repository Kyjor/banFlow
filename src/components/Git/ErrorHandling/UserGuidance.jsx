...
const UserGuidance = ({ visible, onClose, userLevel = 'beginner' }) => {
  ...
  const beginnerSteps = [
      ...
      content: (
        <div>
          <Paragraph>
            ...
            Think of it as a "save game" system for your code, where you can go back to any previous version.
          </Paragraph>
          <Alert
            message="Key Concepts"
            description={
              <ul>
                <li><strong>Repository:</strong> A folder that contains your project and its history</li>
                <li><strong>Commit:</strong> A saved snapshot of your changes</li>
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            To start using Git, you need to add a repository. This can be an existing project 
            or a new one you want to track.
          </Paragraph>
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            When you modify files, Git tracks these changes. The "Changes" tab shows you 
            exactly what has been added, removed, or modified.
          </Paragraph>
            ...
            <Alert
              ...
              description={
                <Space direction="vertical">
                  <Space><Tag color="green">Green</Tag> - New files or additions</Space>
                  <Space><Tag color="red">Red</Tag> - Deleted lines</Space>
                  <Space><Tag color="blue">Blue</Tag> - Modified files</Space>
                  <Space><Tag color="orange">Orange</Tag> - Staged changes</Space>
                </Space>
              }
              type="info"
              showIcon
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            Before committing, you need to "stage" your changes. This tells Git which 
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            A commit is like saving your game - it creates a permanent snapshot of your changes 
            with a message describing what you did.
          </Paragraph>
          <Alert
            ...
            description={
              <ul>
                ...
                <li>Examples: "Fix login bug", "Add user authentication", "Update documentation"</li>
              </ul>
            }
            type="success"
            showIcon
  ...
  const intermediateSteps = [
    {
      ...
      content: (
        <div>
          <Paragraph>
            Branches allow you to work on different features without affecting your main code. 
            Think of them as parallel universes for your code.
          </Paragraph>
          <Steps direction="vertical" size="small">
            <Step
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            Conflicts happen when Git can't automatically merge changes. The three-pane view 
            helps you choose which changes to keep.
          </Paragraph>
          <Alert
            message="Conflict Resolution Options"
            description={
              <Space direction="vertical">
                <Space><Tag color="blue">Accept Incoming</Tag> - Use changes from the other branch</Space>
                <Space><Tag color="orange">Accept Current</Tag> - Keep your current changes</Space>
                <Space><Tag color="green">Accept Both</Tag> - Keep both sets of changes</Space>
                <Space><Tag color="purple">Edit Manually</Tag> - Create a custom resolution</Space>
              </Space>
            }
            type="warning"
            showIcon
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            For more control, you can stage individual chunks or even specific lines within a file. 
            This allows you to commit only the changes you want.
          </Paragraph>
          <List
            size="small"
            dataSource={[
  ...
  const advancedSteps = [
    {
      ...
      content: (
        <div>
          <Paragraph>
            Professional teams use specific Git workflows to coordinate their work. 
            Common patterns include Git Flow, GitHub Flow, and GitLab Flow.
          </Paragraph>
          <Collapse>
            ...
            <Panel header="GitHub Flow" key="2">
              <Paragraph>
                A simpler workflow with just main and feature branches. 
                Good for continuous deployment.
              </Paragraph>
            </Panel>
            <Panel header="GitLab Flow" key="3">
              <Paragraph>
                Combines Git Flow with environment branches for deployment. 
                Good for complex deployment pipelines.
              </Paragraph>
            </Panel>
          </Collapse>
        </div>
    ...
    },
    {
      ...
      content: (
        <div>
          <Paragraph>
            Advanced users can leverage features like rebasing, cherry-picking, and stashing 
            for more sophisticated version control.
          </Paragraph>
          <List
            size="small"
            dataSource={[
  ...
  const progress = ((completedSteps.size + (currentStep === steps.length - 1 ? 1 : 0)) / steps.length) * 100;
      ...
      <div className="guidance-content">
        <div className="progress-section">
          <Progress 
            percent={progress} 
            strokeColor="#52c41a"
            format={() => `${completedSteps.size + (currentStep === steps.length - 1 ? 1 : 0)}/${steps.length} completed`}
          />
        </div>
        ...
        <div className="steps-navigation">
          <Steps
            ...
            items={steps.map((step, index) => ({
              title: step.title,
              status: completedSteps.has(index) ? 'finish' : 
