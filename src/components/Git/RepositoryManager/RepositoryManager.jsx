    ...
    if (status.staged?.length > 0) {
      badges.push(
        <Badge
          key="staged"
          status="processing"
          text={`${status.staged.length} staged`}
        />,
      );
    }
    ...
    if (status.created?.length > 0) {
      badges.push(
        <Badge
          key="created"
          status="success"
          text={`${status.created.length} new`}
        />,
      );
    }
  ...
  return (
    <div className="repository-manager">
      ...
      >
            ...
            <Space direction="vertical" style={{ width: '100%' }}>
              ...
              {projectStats.lastAdded && (
                ...
                >
                  ...
                  <Text type="secondary">
                    {formatLastAccessed(projectStats.lastAdded.addedAt)}
                  </Text>
                </div>
              )}
            </Space>
        ...
        <div className="repository-list">
          ...
          {repositories.length === 0 ? (
            <Empty
              image={
                <GitlabOutlined style={{ fontSize: '48px', color: '#ccc' }} />
              }
              description={
                <div>
                  ...
                  actions={[
                    <Tooltip title="Switch to this repository" key="switch">
                      <Button
                        ...
                        loading={
                          operationInProgress && selectedRepo === repo.path
                        }
      ...
      >
        <Space direction="vertical" style={{ width: '100%' }}>
          <Paragraph>
            Enter the path to a Git repository or use the file selector to
            browse for one.
          </Paragraph>
          <Input
          ...
          />
          <Text type="secondary">
            The selected directory must be a valid Git repository (contain .git
            folder).
          </Text>
        </Space>
      </Modal>
      ...
      >
        <Space direction="vertical" style={{ width: '100%' }}>
          <Paragraph>
            This will remove all repositories from the project that no longer
            exist on disk. This action cannot be undone.
          </Paragraph>
          <Text type="warning">
            ⚠️ Only repositories that have been moved or deleted will be
            removed. Valid repositories will remain in the project.
          </Text>
        </Space>
      </Modal>
    </div>
